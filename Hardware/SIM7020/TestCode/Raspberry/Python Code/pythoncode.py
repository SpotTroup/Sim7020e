...
##########################################################################################################################################
	...
	# wait for 10 seconds before giving up on a command (it is high to account for the GPS latency)
	TIMEOUT = 10
	ENTER_KEY = '\r\n'
	...
	def send_command(cmd):
	    ...
	    print(rxbuffer)
	    # read any additional characters to empty out buffer
	    print(sr_dev.read(100))
	    time.sleep(5)
	    return rxbuffer
